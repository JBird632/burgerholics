...
var BackgroundView = function (_Backbone$View) {
    _inherits(BackgroundView, _Backbone$View);
    ...
    _createClass(BackgroundView, [{
        ...
        value: function initialize() {
            this.title = this.$el.find('.headerTitle');
        }
    }, {
        key: 'el',
        value: function el() {
        ...
        value: function setBackground(image) {
            this.$el.css('background-image', 'url("images/' + image + '")');
        }
    }, {
        key: 'setHeadingSize',
        value: function setHeadingSize(size) {
            this.title.css('font-size', size);
        }
    }]);
